...
%The predicted category labels are converted to numeric values using grp2idx.
%Subtracting 1 from each predicted index converts the labels from 1-based indexing to 0-based indexing.
end
